...
function randomCity() {
   let x = Math.floor((Math.random() * worldCities.length) + 1);
   return x;
}

console.log(randomCity());

const url0 = 'https://api.openweathermap.org/data/2.5/weather?q=' + worldCities[randomCity()] + '&appid=027df142e5b67a54015b3e224ea626cb&units=metric';
const url1 = 'https://api.openweathermap.org/data/2.5/weather?q=' + worldCities[randomCity()] + '&appid=027df142e5b67a54015b3e224ea626cb&units=metric';
const url2 = 'https://api.openweathermap.org/data/2.5/weather?q=' + worldCities[randomCity()] + '&appid=027df142e5b67a54015b3e224ea626cb&units=metric';
const url3 = 'https://api.openweathermap.org/data/2.5/weather?q=' + worldCities[randomCity()] + '&appid=027df142e5b67a54015b3e224ea626cb&units=metric';
